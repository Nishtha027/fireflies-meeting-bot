...
export function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-10 flex h-14 flex-shrink-0 items-center border-b border-slate-200 bg-white px-6">
      <div className="relative w-full max-w-md">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2 pl-9 pr-14 text-sm text-slate-900 placeholder:text-slate-400 focus:border-indigo-300 focus:bg-white focus:outline-none"
        />
